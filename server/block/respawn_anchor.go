...
// ConsumeRespawn consumes one charge from the respawn anchor after its safe spawn has been used.
func (r RespawnAnchor) ConsumeRespawn(pos cube.Pos, tx *world.Tx) {
	if r.Charges <= 0 {
		return
	}
	r.Charges--
