...
// IronDoor is a 1x2 barrier that, unlike a WoodDoor, cannot be opened by hand and only responds to redstone.
// TODO: Redstone functionality (opening and closing with the power the door receives).
...
func (d IronDoor) BreakInfo() BreakInfo {
	return newBreakInfo(5, pickaxeHarvestable, pickaxeEffective, oneOf(IronDoor{}))
}
...
// allIronDoors returns a list of all iron door variants.
