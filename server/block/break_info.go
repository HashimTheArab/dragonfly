...
// passed, accounting for the status effects and environment described by the optional context. Omitting the
// context preserves compatibility with integrations that do not yet provide player or environment state.
// See https://minecraft.wiki/w/Breaking#Calculation.
func BreakDuration(b world.Block, i item.Stack, contexts ...BreakContext) time.Duration {
