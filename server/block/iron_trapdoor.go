...
// IronTrapdoor is a 1x1 barrier that, unlike a WoodTrapdoor, cannot be opened by hand and only responds to redstone.
// TODO: Redstone functionality (opening and closing with the power the trapdoor receives).
...
func (t IronTrapdoor) BreakInfo() BreakInfo {
	return newBreakInfo(5, pickaxeHarvestable, pickaxeEffective, oneOf(IronTrapdoor{}))
}
...
// allIronTrapdoors returns a list of all iron trapdoor variants.
